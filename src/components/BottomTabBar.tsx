    ...
    case 'konsumen':
      return (
        <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
          ...
          <Path
            d="M2 21C2 17.134 5.13401 14 9 14C12.866 14 16 17.134 16 21"
            stroke={color}
            strokeWidth="2"
            strokeLinecap="round"
          />
          ...
          <Path
            d="M22 21C22 18.2386 19.7614 16 17 16C16.3128 16 15.6595 16.1362 15.0625 16.3843"
            stroke={color}
            strokeWidth="2"
            strokeLinecap="round"
          />
    ...
    case 'report':
      return (
        <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
          ...
          />
          <Path
            d="M7 14L10.5 10.5L13.5 13.5L20 7"
            stroke={color}
            strokeWidth="2"
            strokeLinecap="round"
            strokeLinejoin="round"
          ...
          return (
            <TouchableOpacity
              ...
              <View style={[styles.iconContainer, isActive && styles.iconContainerActive]}>
                <TabIcon name={tab.icon as string} active={isActive} />
              </View>
