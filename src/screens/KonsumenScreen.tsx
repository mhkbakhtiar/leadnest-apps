...
const KonsumenScreen = ({ navigation }: any) => {
  ...
  const renderItem = ({ item }: { item: Konsumen }) => (
    <TouchableOpacity
      ...
      onPress={() => {
        navigation.navigate('DetailKonsumenScreen', { konsumenId: item.id, konsumen: item });
      }}
    >
...
// Add Konsumen Modal
export const AddKonsumenModal = ({ visible, onClose, onSuccess }: any) => {
...
// Edit Konsumen Modal  
export const EditKonsumenModal = ({ visible, konsumen, onClose, onSuccess }: any) => {
  const [formData, setFormData] = useState({
    name: '',
    whatsapp: '',
    email: '',
