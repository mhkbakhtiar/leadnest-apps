...
type AddFollowupRouteProp = RouteProp<RootStackParamList, 'AddFollowupScreen'>;
type AddFollowupNavProp = NativeStackNavigationProp<RootStackParamList, 'AddFollowupScreen'>;

const AddFollowupScreen = () => {
  const navigation = useNavigation<AddFollowupNavProp>();
  const route = useRoute<AddFollowupRouteProp>();
  const { konsumenId } = route.params;
  ...
  return (
    <SafeAreaView style={styles.screen} edges={['top', 'bottom']}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Tambah Follow Up</Text>
        <View style={{ width: 32 }} />
      </View>
